...
def build_parser():
    ...
    ap.add_argument('--radius_scale', type=float, default=0.8)
    ap.add_argument('--scene_bbox_size', type=float, default=2.6)
    ap.add_argument('--test_num', type=int, default=10)
    ap.add_argument('--val_num', type=int, default=0)
    ap.add_argument('--split_strategy', default='tail')
    ap.add_argument('--cmaps', default='Fast')
    ap.add_argument('--band_count', type=int, default=10)
    ap.add_argument('--shading', type=int, default=0)
    ap.add_argument('--opaque_unit', type=float, default=1.5)
    ap.add_argument('--fxaa', type=int, default=1)
    ap.add_argument('--png_compress', type=int, default=3)
    ap.add_argument('--tf_mode', default='linear')
    ap.add_argument('--range', default='')
    ap.add_argument('--array_name', default=None)
    ...
    ap.add_argument('--adaptive_camera', type=int, default=0)
    ap.add_argument('--anysplat_root', default=None)
    ap.add_argument('--anysplat_only', action='store_true')
    return ap
